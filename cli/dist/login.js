    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            server = app.listen(port, function () {
                ...
                void (0, open_1.default)("http://localhost:5173/login?redirect=http://localhost:".concat(port, "/callback"));
            });
            app.get('/callback', function (req, res) {
                var _a = req.query, accessToken = _a.accessToken, refreshToken = _a.refreshToken;
